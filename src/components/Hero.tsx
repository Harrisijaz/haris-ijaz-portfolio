...
const Hero = () => {
  ...
  return (
    <section id="home" className="animated-gradient relative flex min-h-screen items-center overflow-hidden px-4 pt-24 sm:px-6 lg:px-8">
      ...
      <div className="relative z-10 mx-auto grid w-full max-w-7xl items-center gap-14 py-16 lg:grid-cols-[1.1fr_0.9fr]">
        <motion.div initial={{ opacity: 0, x: -40 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.7 }}>
          <p className="mb-5 inline-flex rounded-full border border-sky-400/30 bg-sky-400/10 px-4 py-2 text-sm font-semibold text-sky-200">
          ...
          <p className="typing-caret mt-6 min-h-9 text-xl font-semibold text-sky-200 sm:text-2xl">{typedText}</p>
          ...
          <div className="glass relative overflow-hidden rounded-[2rem] p-8">
            <div className="aspect-[4/5] rounded-[1.5rem] bg-gradient-to-br from-blue-600 via-sky-400 to-slate-900 p-1">
              <div className="flex h-full items-center justify-center rounded-[1.35rem] bg-slate-950">
                <img alt="Professional profile placeholder" className="h-44 w-44 object-contain opacity-95" src={heroImg} />
              </div>
            </div>
